...
namespace SantaPuppet.Songs
{
    ...
    public class ItsTheMostWonderfulTimeOfTheYear
    {
        ...
        {         
            ...
            feetTest.CueTime = 2;
            feetTest.CueAction = () => ani.Feet(false, 200, 2);
            feetTest.CueName = "Feet Right";
            song.Cues.Add(feetTest);

            CueModel leftArmTest = new CueModel();
            leftArmTest.CueTime = 700;
            leftArmTest.CueAction = () => ani.LeftArm(false, 200, 2);
            leftArmTest.CueName = "Left Arm";
            song.Cues.Add(leftArmTest);

            CueModel rightArmTest = new CueModel();
            rightArmTest.CueTime = 1800;
            rightArmTest.CueAction = () => ani.RightArm(false, 200, 2);
